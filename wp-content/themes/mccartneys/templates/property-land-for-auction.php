...
get_header(); ?>
<main class="agricultural-letting page-wrap"> 
    <!-- Inner Banner -->
                ...
                <div class="col-12 col-md-6">
                    ...
                    <?php 
                        ...
                        if( $center_buy_button ): 
                            ...
                            ?>
                            <a class="btn-cs-dark" href="<?php echo esc_url( $center_buy_button_url ); ?>" target="<?php echo esc_attr( $center_buy_button_target ); ?>"><?php echo esc_html( $center_buy_button_title ); ?><span><i class="fa-solid fa-angle-right"></i></span></a>
                        <?php endif; ?>
                        <?php 
                        ...
                        if( $center_sell_button ): 
                            ...
                            ?>
                            <a class="btn-cs-white" href="<?php echo esc_url( $center_sell_button_url ); ?>" target="<?php echo esc_attr( $center_sell_button_target ); ?>"><?php echo esc_html( $center_sell_button_title ); ?><span><i class="fa-solid fa-angle-right"></i></span></a>
                        <?php endif; ?>
                    </div>
                    </div>
                </div>
