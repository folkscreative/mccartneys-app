...
/**
 * Template Name: Agriculture Sale Template
 */

get_header(); ?>
<main class="agriculture-sales property-sub-page page-wrap">
    <!-- Inner Banner -->
            ...
            <div class="tab-content" id="propertyTabContent">
                ...
                <div class="tab-pane fade" id="sale" role="tabpanel" aria-labelledby="tab-sale">
                    <div class="inner-tabs pr">
                        ...
                        <?php
                        $department = "agricultural"; // Assuming department is set here
                        $property_count = 0; // Assuming property count is set here

                        if ($department == "agricultural" && $property_count == 0) {
            ...
            <div class="depart-slider depar">
                ...
                <?php 
                        ...
                        <a class="btn-transparent" href="<?php echo esc_url( $department_cartneys_slider_link_url ); ?>"
                            target="<?php echo esc_attr( $department_cartneys_slider_link_target ); ?>"><?php echo esc_html( $department_cartneys_slider_link_title ); ?></a>
                        <?php endif; ?>
                    <?php
