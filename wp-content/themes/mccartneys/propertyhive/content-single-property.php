        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-8" style="position: relative; ">
                    ...
                    <div class="branch-share-popup">
                        ...
                        <div class="copy-outer">
                            <div class="copy-url-img">
                                <img
                                    src="https://wordpress-1285863-4695980.cloudwaysapps.com/wp-content/uploads/2024/09/copy-icon.svg">
                            </div>
                    ...
                    <?php if ( isset($property->council_tax_band) || isset($property->tenure) ) {
                        ?>
