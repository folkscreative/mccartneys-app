...
<main class="property-search page-wrap">
    <section class="search-outer d-md-block">
        <div class="container">
    ...
    <!-- <section class="search-outer filter d-block d-md-none">
        <div class="container">
            <div class="mobile-filter">
                <?php // echo do_shortcode('[property_search]') ?>
                <a href="#" class="filter-btn">Filter <svg xmlns="http://www.w3.org/2000/svg" width="18" height="17"
                        viewBox="0 0 18 17" fill="none" class="open">
                        <path
